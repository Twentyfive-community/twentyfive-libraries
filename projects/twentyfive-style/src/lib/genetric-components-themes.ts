...
export enum ButtonTheme {
  ...
  Fat = 'btn-fat',
  FatReverse = 'btn-fat-reverse',
  DisabledFat = 'btn-fat-disabled',
  ...
  SecondaryOnlyIconSmall = 'btn-only-icon-secondary-sm',
  ...
  SecondaryOnlyIconCircularSmall = 'btn-only-icon-secondary-circular-sm',
  ...
  SecondaryOnlyIconSquareSmall = 'btn-only-icon-secondary-square-sm',
...
export enum ChipTheme {
  Primary = 'twentyfive-chip-primary',
  Secondary = 'twentyfive-chip-secondary',
}
